...
var path="";//created by sara to dispaly path of the selected branch
// jQuery plugin
...
function tree_component () {
	...
	return {
		...
		select_branch : function (obj, multiple) {
			...
			if(document.getElementById('dpath'))
			{
				path="";
				this.selected.children("a").parents("li.open").each(function () { _this.display_branch(this);});
				path = path + this.selected.children("a")[0].innerHTML;
				document.getElementById('dpath').innerHTML = "<b>Selected path:</b> "+path;
			}
			///////////////////////////////end sara/////////////////////////
			// SCROLL SELECTED NODE INTO VIEW
		...
		//////////////////////////////begin sara code///////////////////		
		display_branch : function (obj) {
			var _this = this;
			var obj = this.get_node(obj);
			path = obj.children("a")[0].innerHTML + " >> " + path;
		},
		//////////////////////////////end sara code///////////////////		
